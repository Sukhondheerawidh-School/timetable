  ...
  <div class="max-w-xl mx-auto px-4">
    ...
    <form method="post" class="bg-white rounded-2xl shadow border border-slate-200 p-6 space-y-4">
      ...
      <div>
        ...
        <input name="year_label" class="w-full border border-slate-200 rounded-xl px-3 py-2 bg-white focus:ring-2 focus:ring-indigo-300 focus:border-indigo-400 outline-none transition text-sm" required placeholder="เช่น 2025" value="<?= htmlspecialchars($_POST['year_label'] ?? ''); ?>">
