...
- รหัสบัตรประชาชน / national_id  (ไม่บังคับ)
- ชื่อผู้ใช้ / username  (ไม่บังคับ)
- คำนำหน้า / title
- ชื่อ / first_name
- นามสกุล / last_name
...
// ตัวอย่าง (ลบได้)
fputcsv($out, ['t00400','1212212112121','sutha','นาย','สุทา','โร','Sutha','Ro','sutha@example.com','changeme123','คณิตศาสตร์']);
